...
export default function Excuse(props: ExcuseProps) {
    ...
    return (
        <div className="addiction-alert-container">
            ...
            <input className="addiction-text-input-20" id="addiction-excuse-input" onChange={(e) => setExcuse(e.target.value)} value={excuse} type="text" placeholder='Your fake "good" reason'></input>
            {(excuse !== undefined && excuse.length > 2) && <button className="strong-addiction-button" onClick={onEnter}>enter... </button>}
